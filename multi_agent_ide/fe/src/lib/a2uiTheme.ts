...
export type Theme = A2uiCore.Types.Theme;
...
const aLight = A2uiCore.Styles.merge(a, {});
const inputLight = A2uiCore.Styles.merge(input, {});
const textareaLight = A2uiCore.Styles.merge(textarea, {});
const buttonLight = A2uiCore.Styles.merge(button, {});
const bodyLight = A2uiCore.Styles.merge(body, {});
const pLight = A2uiCore.Styles.merge(p, {});
const preLight = A2uiCore.Styles.merge(pre, {});
const orderedListLight = A2uiCore.Styles.merge(orderedList, {});
const unorderedListLight = A2uiCore.Styles.merge(unorderedList, {});
const listItemLight = A2uiCore.Styles.merge(listItem, {});
  ...
  if (!customElements.get("a2ui-theme-provider")) {
    class A2uiThemeProvider extends HTMLElement {
      private provider: ContextProvider<
        typeof A2uiCore.UI.Context.themeContext,
        HTMLElement
      >;
